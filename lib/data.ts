export const VENUE_INFO = {
  ...
  rating: 3.8,
  reviews: 240,
  address: '22-421, Tirupati Road, Kattamanchi, Chittoor, Andhra Pradesh – 517001',
  phone: '098482 61414',
...
export const FACILITIES = [
  {
    ...
    description: 'Elegant marriage hall on first floor with beautiful architecture and premium décor',
  },
  {
    id: 2,
    icon: '🍽️',
  ...
  },
  {
    ...
    icon: '✨',
    title: 'Premium Décor',
    description: 'Professional décor and flowers arrangement for weddings and special events',
  },
]
...
export const HIGHLIGHTS = [
  ...
  {
    title: 'Marriage Hall',
    description: 'Elegant first-floor hall with premium décor',
  },
  {
    title: 'Family Rooms',
...
export const GALLERY_IMAGES = [
  ...
  alt: 'Grand wedding stage decoration in Srimathi Santharaghuraman Kalyana Mandapam Chittoor',
  category: 'stage',
...
},
  {
    id: 2,
    src: '/Dh.jpeg',
    alt: 'Spacious dining hall at Srimathi Santharaghuraman wedding hall Chittoor',
    category: 'dining',
    title: 'Dining Hall',
  },
  {
    id: 3,
    src: '/fROOMS.jpeg',
    alt: 'Premium family rooms at Kalyana Mandapam in Chittoor',
    category: 'rooms',
    title: 'Family Rooms',
  },
  {
    id: 4,
    src: '/mandapam.jpeg',
    alt: 'Exterior view of Srimathi Santharaghuraman Kalyana Mandapam wedding hall Chittoor',
    category: 'exterior',
    title: 'Exterior View',
  },
  {
    id: 5,
    src: '/stageflower.jpeg',
    alt: 'Elegant stage lighting for reception at wedding hall Chittoor',
    category: 'stage',
  ...
  },
  {
    id: 6,
    src: '/Dh.jpeg',
    alt: 'Ground floor dining area catering setup Chittoor',
    category: 'dining',
  ...
  },
  {
    id: 7,
    src: '/fROOMS.jpeg',
    alt: 'Modern guest facilities at Chittoor marriage hall',
    category: 'rooms',
  ...
  },
  {
    id: 8,
    src: '/KL.jpeg',
    alt: 'Main entrance of Srimathi Santharaghuraman Kalyana Mandapam Chittoor',
    category: 'exterior',
    title: 'Entrance Gate',
  },
]
